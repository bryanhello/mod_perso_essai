...
public enum ModArmorMaterials implements ArmorMaterial {
    ELENITE("elenite", 28, new int[]{2, 5, 8, 3}, 19, SoundEvents.ARMOR_EQUIP_GOLD,
            2.0F, 0.0F, () -> Ingredient.of(ModItems.ELENITE_INGOT.get()));
    ...
    public String getName() {
        return MysticalMod.MOD_ID + ":" + this.name;
    }
